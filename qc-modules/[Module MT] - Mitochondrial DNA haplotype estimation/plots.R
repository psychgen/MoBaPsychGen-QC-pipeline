...
message(
    '\nSample: ', sample,
    '\nGenotyped Files: ', typ_map.path, ', ', typ_ped.path,
    '\nImputed Files: ', imp_map.path, ', ', imp_ped.path, ', ', imp_info.path,
    '\nInfo Score Cuttoff: ', info_cut,
...
HiMC <- tibble(
  himc = 'yes',
  pos = as.numeric(c(
      '10115', '1018', '10398', '10400', '10550', '11177', '11251', '11719',
      '11947', '12007', '12308', '12414', '12705', '13263', '13368', '13506',
      '13708', '13789', '14178', '14318', '1438', '14470', '14560', '14668',
      '14766', '14905', '15043', '15326', '15452', '15535', '16111', '16189',
      '16271', '16362', '16390', '16391', '16391', '1719', '1736', '2092', '3505',
      '3552', '3594', '4580', '4769', '4883', '4917', '4977', '5178', '5442',
      '6371', '7028', '825', '8251', '8414', '8468', '8703', '9042', '9055',
      '9347', '9950')),
  Haplogroup = c(
      "L2", "L3", "K1", "M", "K", "B2", "JT", "R0", "W", "A2", "U", "N2", "R",
      "C", "T", "L2'3'4'6", "J", "L1", "L1", "C", "H2", "K", ".", "D4", "HV",
      "T", "N1a1b", "H2a2a", "JT", "B4b'd'e", "A2", "T1", "JT", "L4", "L2", "I",
      "I", "X2", "A", "D1", "W", "C", "L3'4", "V", "H2a", "M80'D", "T", "B2",
      "D ", "L0", "X ", "H", "L2'3'4'6", "N1a1b", "D4", "L2'3'4'6", "D2", "L0",
      "U8b", "L0", "B2"))

## Read in / munge data ------------------------------------------------------##
message("\n Reading in and wrangling genotyped and imputed data")
...
ggsave(
    plot = p1, filename = paste0(outdir, '/', sample, '_Info.png'),
    device = 'png', width = 19.2, height = 6.87, units = 'cm'
)

# Info Score of imputed mtSNPs across the mitochondrial genome highlighting Hi-MC mtSNPs used in haplgroup assignment
p2 <- ggplot(samp_imp.info, aes(x = position, y = info_comb, colour = as.factor(type), alpha = himc)) +
    geom_point() +
    theme_bw() +
    labs(
      x = 'mtDNA position',
...
ggsave(
    plot = p2, filename = paste0(outdir, '/', sample, '_InfoHiMC.png'),
    device = 'png', width = 19.2, height = 6.87, units = 'cm'
)

# Haplogroup Classification --------------------------------------------------##
# Hi-MC (Smieszek et al PeerJ 2018), a broad haplogroup classifier for European,
# African, and Native American mitochondrial haplogroups, is used to assign samples
# to macro haplogroups. Hi-MC was developed using a reduced mitochondrial phylogenetic tree
...
##   Imputed
### remove sites with poor info scores (< Info Cutoff)
...
p3 <- ggplot(dat.p, aes(x = haplogroup_imp, y = haplogroup_typ, fill = n, label = n)) +
  ...
  labs(
      x = 'Haplgroups assigned using \nimputed data',
      y = 'Haplgroups assignedusing \nun-imputed data'
  )

ggsave(
    plot = p3, filename = paste0(outdir, '/', sample, '_HaplogroupMatch.png'),
