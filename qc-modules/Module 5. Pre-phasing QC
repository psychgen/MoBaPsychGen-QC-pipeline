...
These steps are run using the PRE_PHASING_QC.job script. The input to this script is one “bfile” in plink format (.bed/.bim/.fam), with approximately 400K-800K genetic variants.
...
The report is generated using the python script pre_phasing_qc_report.py.
